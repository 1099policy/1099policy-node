...
Ten99PolicyResource.prototype = {
  ...
  _responseHandler(req, callback) {
    return (res) => {
      ...
      res.once('end', () => {
        ...
        const ten99policyEnvironment = headers['ten99policy-environment'];
        if (ten99policyEnvironment) {
          res.ten99policyEnvironment = ten99policyEnvironment;
        }
  ...
  _makeHeaders(
    ...
    const defaultHeaders = {
      ...
      'Ten99Policy-Environment': environment || 'sandbox',
  ...
  _request(method, host, path, data, auth, options = {}, callback) {
    ...
    const prepareAndMakeRequest = (error, data) => {
      ...
      this._ten99policy.getClientUserAgent((clientUserAgent) => {
        ...
        const environment = this._ten99policy.getApiField('environment');
