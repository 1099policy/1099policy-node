...
const utils = (module.exports = {
    ...
    if (
      ...
      emitWarning(
        `Options found in arguments (${optionKeysInArgs.join(
          ', '
        )}). Did you mean to pass an options object? See https://github.com/1099policy/ten99policy-node/wiki/Passing-Options.`
      );
    }
    ...
    if (args.length > 0) {
      ...
      if (typeof arg === 'string') {
        ...
        if (params.ten99policyEnvironment) {
          opts.headers['Ten99policy-Environment'] =
            params.ten99policyEnvironment;
        }
  ...
  protoExtend(sub) {
    ...
    // context:
    //
    // https://github.com/1099policy/ten99policy-node/pull/334
